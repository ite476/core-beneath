...
### PoC 우선 운영 원칙
- 자원 종류 확장보다 핵심 루프 완결성을 우선합니다.
- 수치 밸런싱은 플레이 가능한 PoC 확보 후 2차 조정합니다.
- 현재 자원 체계는 `v0 baseline`으로 두고, 실제 플레이 데이터를 반영해 조정합니다.
...
| 날짜 | 변경 내용 | 작성자 |
| --- | --- | --- |
| 2026-03-09 | PoC 우선 자원 운영 원칙 추가 | Codex |
